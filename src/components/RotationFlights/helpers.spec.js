import {isNotPassedMidnight, couldItBeTheNextFlight, doesRespectTheTurnaround} from './helpers'
...
describe('couldItBeTheNextFlight method', () => {
    ...
    beforeEach(() => {
        mockQueue = []
        mockFlight1 = {"ident":"AS1001","departuretime":21600,"arrivaltime":26100,"readable_departure":"06:00","readable_arrival":"07:15","origin":"LFSB","destination":"LFMN"}
        mockFlight2 = {"ident":"AS1002","departuretime":27900,"arrivaltime":32100,"readable_departure":"07:45","readable_arrival":"08:55","origin":"LFMN","destination":"LFSB"}
    })

    describe('when the queue is empty', () => {
        it('should be able return the flight', () => {
            expect(couldItBeTheNextFlight(mockQueue, mockFlight1)).toMatchObject(mockFlight1)
        })
    })
    ...
    describe('when the queue has flights', () => {
        describe('and the flight to be added follow the rules', () => {
            it('should be able to return the last flight added', () => {
                ...
                expect(couldItBeTheNextFlight(mockQueue, mockFlight2)).toMatchObject(mockFlight2)
            })
        })
