        ...
        <Container ref={timelineRef}>
            {flights.map((flight, index, flightsSelected) => {
                ...
                return (
                    <div key={flight.id}>
                        {previousFlight && 
                            <TurnaroundTime style={{left: `${getPosition(previousFlight.arrivaltime)}px`, width: `${getPosition(flight.departuretime-previousFlight.arrivaltime)}px`}} />
                        }
                        <ScheduleService style={{left:`${getPosition(flight.departuretime)}px`, width: `${getPosition(flight.arrivaltime-flight.departuretime)}px`}} />
                    </div>
                )
            })}
        </Container>
